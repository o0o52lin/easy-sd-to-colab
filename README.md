...
拷贝以下代码到colab并运行
```
!bash <(curl -sL https://raw.githubusercontent.com/o0o52lin/sd-template/main/3sd.sh)
```

### 其他基于jupyter notebook的在线云服务
拷贝粘贴以下代码并运行
```
!curl -sL https://raw.githubusercontent.com/o0o52lin/sd-template/main/3sd.sh | bash -i /path/to/SD/folder
```
...
```
!bash <(curl -sL https://raw.githubusercontent.com/o0o52lin/sd-template/main/3sd.sh) -l https://github.com/xxx/yyy -n example-template
```
...
```
!bash <(curl -sL https://raw.githubusercontent.com/o0o52lin/sd-template/main/3sd.sh) -n vanwise -l /content/drive/MyDrive/template
```
